...
const STARTER_ABILITIES: PlayerAbilityDef[] = [
  ...
  },
  {
    id: 'scan-mk1',
    name: 'Scan',
    description: 'Reveal enemy ability details for 15 seconds.',
    slot: 'utility',
    category: CombatActionCategory.SABOTAGE,
    cooldown: 8,
    cost: { type: 'insight', amount: 5 },
    statusEffect: { type: 'EXPOSE', duration: 8, magnitude: 1 },
    tier: 0,
  },
];
...
const NEBULA_ABILITIES: PlayerAbilityDef[] = [
  // Shield line
  {
    ...
    description: 'Shields that slowly restore themselves over time. Passive: +2 shield/sec.',
    slot: 'shield',
    category: CombatActionCategory.SHIELD,
    passive: true,
    cooldown: 0,
  ...
  },
  {
    ...
    description: 'Advanced shields that absorb more damage. Passive: +4 shield/sec.',
    slot: 'shield',
    category: CombatActionCategory.SHIELD,
    passive: true,
    cooldown: 0,
  ...
  },
  {
    ...
    description: 'Legendary shielding. Passive: +8 shield/sec, shields absorb 20% hull damage.',
    slot: 'shield',
    category: CombatActionCategory.SHIELD,
    passive: true,
    cooldown: 0,
...
const RADIATION_ABILITIES: PlayerAbilityDef[] = [
  ...
  // Cyber line
  {
    ...
    description: 'Confuse enemy targeting. Reduces enemy damage by 20% for 8s.',
    slot: 'utility',
    category: CombatActionCategory.SABOTAGE,
    cooldown: 10,
    cost: { type: 'insight', amount: 8 },
    statusEffect: { type: 'WEAKEN', duration: 4, magnitude: 0.2 },
    prereq: 'scan-mk1',
    unlockCost: { material: 'exoticData', amount: 5 },
    tier: 1,
  },
  {
    id: 'hack',
    name: 'Hack',
    description: 'Disable one enemy ability for 10 seconds.',
    slot: 'utility',
    category: CombatActionCategory.SABOTAGE,
    cooldown: 15,
    cost: { type: 'insight', amount: 15 },
    statusEffect: { type: 'DISABLE', duration: 5, magnitude: 1 },
...
const CAPSTONE_ABILITIES: PlayerAbilityDef[] = [
  ...
  },
  {
    ...
    description: 'Stance: all weapons deal +50% damage, but shields drain 5/sec.',
    slot: 'stance',
    category: CombatActionCategory.WEAPON,
    cooldown: 10,
