...
import { Users, Gem, ChevronUp } from "lucide-react"
...
export default function CrewQuartersPage() {
  ...
  const ammoTier = state.ammo.repairKits.tier
        ...
        <div className="space-y-3 pt-4 border-t border-border">
          ...
          {ammoTier < 3 && (
            <div
              ...
              onClick={() => dispatch({ type: 'UPGRADE_AMMO_CAPACITY', payload: { ammoType: 'repairKits' } })}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <ChevronUp className="h-4 w-4 text-chart-5 mr-2" />
                  <span className="text-sm">Repair Kit Capacity</span>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">
                Upgrade to {AMMO_TIER_NAMES[ammoTier + 1]} — max {getAmmoMax('repairKits', ammoTier + 1)} Repair Kits
              </p>
            </div>
          )}
        </div>
