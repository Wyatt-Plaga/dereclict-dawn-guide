...
import { BaseUpgrade } from '../models/BaseUpgrade';
import { EffectUpgrade } from '../models/EffectUpgrade';
import { ResourceUpgrade } from '../models/ResourceUpgrade';
import { UnlockUpgrade } from '../models/UnlockUpgrade';
import { 
  Upgrade, 
  UpgradeProperties, 
  UpgradeRegistry, 
...
} from '../interfaces/UpgradeInterfaces';
...
export class UpgradeManager implements UpgradeRegistry {
  ...
  public applyAllUpgradeEffects(): void {
    // Use Array.from to avoid linter issues with Map iteration
