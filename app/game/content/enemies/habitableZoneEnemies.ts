...
export const HABITABLE_ZONE_ENEMIES: EnemyDefinition[] = [
    // =====================
    ...
    
    {
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'Orbital Graveyard', weight: 1 }],
    ...
    },
    {
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'Orbital Graveyard', weight: 3 }],
        ...
        loot: [ { type: 'scrap', amount: 5 }, { type: 'energy', amount: 5 } ]
    },
    {
    ...
    
    {
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'Fallen Worlds', weight: 1 }],
        ...
        loot: [ { type: 'scrap', amount: 8 }, { type: 'crew', amount: 1, probability: 0.1 } ]
    },
    {
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'Fallen Worlds', weight: 2 }],
    ...
    },
    {
        ...
        loot: [ { type: 'scrap', amount: 10 }, { type: 'energy', amount: 3 } ]
    },
    ...
    
    {
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'The Last Metropolis', weight: 2 }],
        ...
        loot: [ { type: 'scrap', amount: 10 }, { type: 'insight', amount: 5 } ]
    },
    {
        id: 'habitable-resource-raider',
        name: 'Resource Raider',
        description: 'Gangs operating outside the Metropolis\' strict laws, raiding supply lines and attacking vulnerable targets for essential resources.',
        type: EnemyType.VESSEL,
        maxHealth: 50,
        health: 50,
        shield: 15,
        ...
        lastAttackTime: 0,
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'The Last Metropolis', weight: 1 }],
        introTitle: "Supply Line Ambush",
        ...
        loot: [ { type: 'scrap', amount: 15 }, { type: 'energy', amount: 5, probability: 0.6 } ]
    },
    {
        id: 'habitable-knowledge-broker',
        name: "Knowledge Broker's Guard",
        description: 'Heavily armed guard protecting illicit information brokers who deal in salvaged data and forbidden pre-collapse knowledge.',
        type: EnemyType.VESSEL,
        maxHealth: 45,
        health: 45,
        shield: 30,
        ...
        isBoss: false,
        spawnLocations: [{ regionId: 'habitable', subRegionId: 'The Last Metropolis', weight: 1 }],
        introTitle: "Information Lockdown",
        ...
        loot: [ { type: 'insight', amount: 12 }, { type: 'energy', amount: 8 } ]
    },
    ...
    {
        id: 'habitable-enforcer-mech-boss',
        name: 'Metropolis Enforcer Mech',
        description: 'A rare piece of functioning pre-collapse military hardware used by the Metropolis elite to maintain absolute control. Heavily armed and armored.',
        ...
        isBoss: true,
        spawnLocations: [],
        introTitle: "Iron Fist of the Council",
        ...
        loot: [ { type: 'scrap', amount: 55 }, { type: 'insight', amount: 25 }, { type: 'energy', amount: 20 } ]
    }
]; 